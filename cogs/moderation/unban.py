...
class ReasonModal(ui.Modal):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        try:
            await self.user.send(f"<:alert:1348340453803687966> You have been Banned from **{self.author.guild.name}** by **{self.author}**. Reason: {reason or 'No reason provided'}")
            dm_status = "Yes"
...
class Unban(commands.Cog):
    ...
    async def unban(self, ctx, user: discord.User, *, reason=None):
        ...
        embed = discord.Embed(description=f"**<:member:1348326398929932388> Target User:** [{user}](https://discord.com/users/{user.id})\n**<:circle2:1348326520581521469> User Mention:** {user.mention}\n**<:mail:1348340617935065240> DM Sent:** {dm_status}\n**<:proton:1348340511303270461> Reason:** {reasonn}", color=self.color)

...
class LockUnlockView(ui.View):
    ...
    async def lock(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed = discord.Embed(
            description=f"<:tabs:1348326390222557278> **Channel**: {self.channel.mention}\n<:proton:1348340511303270461> **Status**: Locked\n<:arrow_right:1348340445708816494> **Reason:** Lock request by {self.author}",
            color=0x000000
        )
...
class Unlock(commands.Cog):
    ...
    async def unlock_command(self, ctx, channel: discord.TextChannel = None):
        ...
        embed = discord.Embed(
            description=f"<:tabs:1348326390222557278> **Channel**: {channel.mention}\n<:proton:1348340511303270461> **Status**: Unlocked\n<:arrow_right:1348340445708816494> **Reason:** Unlock request by {ctx.author}",
            color=self.color
        )

...
class Kick(commands.Cog):
    ...
    async def kick_command(self, ctx, member: discord.Member, *, reason: str = None):
        ...
        embed = discord.Embed(
            description=(
                f"**<:member:1348326398929932388> Target User:** [{member}](https://discord.com/users/{member.id})\n"
                f"<:circle2:1348326520581521469> **User Mention:** {member.mention}\n"
                f"<:proton:1348340511303270461> **Reason:** {reason}\n"

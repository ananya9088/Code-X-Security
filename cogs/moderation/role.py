...
class Role(commands.Cog):
  ...
  async def role_humans(self, ctx, *, role: discord.Role):
    if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            if interaction.user == ctx.author:
                if interaction.guild.me.guild_permissions.manage_roles:
                    ...
                    await interaction.channel.send(
                        content=f"<:tick:1348326381611647046> | Successfully assigned {role.mention} to {count} human(s).")
                else:
                    await interaction.response.edit_message(
                        content="<:alert:1348340453803687966> I am missing the required permissions. Please grant the necessary permissions and try again.",
                        embed=None,
                        view=None)
            else:
        ...
        if len(members_without_role) == 0:
            return await ctx.reply(embed=discord.Embed(description=f"<:alert:1348340453803687966> | All humans already have the {role.mention} role.", color=self.color))
        else:
            embed = discord.Embed(
                color=self.color,
  ...
  async def role_bots(self, ctx, *, role: discord.Role):
    if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
        ...
        async def button_callback(interaction: discord.Interaction):
            ...
            if interaction.user == ctx.author:
                if interaction.guild.me.guild_permissions.manage_roles:
                    ...
                    await interaction.channel.send(
                        content=f"<:tick:1348326381611647046> | Successfully added {role.mention} to {count} bot(s).")
                else:
                    await interaction.response.edit_message(
        ...
        if len(bots_without_role) == 0:
            return await ctx.reply(embed=discord.Embed(description=f"<:alert:1348340453803687966> | All bots already have the {role.mention} role.", color=self.color))
        else:
            embed = discord.Embed(
                color=self.color,
        ...
        async def button_callback(interaction: discord.Interaction):
            ...
            if interaction.user == ctx.author:
                if interaction.guild.me.guild_permissions.manage_roles:
                    ...
                    await interaction.channel.send(
                        content=f"<:tick:1348326381611647046> | Successfully added {role.mention} to {count} unverified member(s).")
                else:
                    await interaction.response.edit_message(
                        content="I am missing the required permission. Please grant the necessary permissions and try again.",
                        embed=None,
  ...
  async def role_all(self, ctx, *, role: discord.Role):
    if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
        ...
        async def button_callback(interaction: discord.Interaction):
            ...
            if interaction.user == ctx.author:
                if interaction.guild.me.guild_permissions.manage_roles:
                    ...
                    await interaction.channel.send(
                        content=f"<:tick:1348326381611647046> | Successfully added {role.mention} to {count} member(s).")
                else:
                    await interaction.response.edit_message(
                        content="I am missing the required permission. Please grant the necessary permissions and try again.",
                        embed=None,
        ...
        if len(members_without_role) == 0:
            return await ctx.reply(embed=discord.Embed(description=f"<:alert:1348340453803687966> | {role.mention} is already given to all the members of the server.", color=self.color))
        else:
            embed = discord.Embed(
                color=self.color,
        ...
        async def button_callback(interaction: discord.Interaction):
            ...
            if interaction.user == ctx.author:
                if interaction.guild.me.guild_permissions.manage_roles:
                    ...
                    await interaction.channel.send(
                        content=f"<:tick:1348326381611647046> | Successfully removed {role.mention} from {count} human(s).")
                else:
                    await interaction.response.edit_message(
                        content="I am missing the required permission. Please grant the necessary permissions and try again.",
                        embed=None,
        ...
        async def button_callback(interaction: discord.Interaction):
            ...
            if interaction.user == ctx.author:
                if interaction.guild.me.guild_permissions.manage_roles:
                    ...
                    await interaction.channel.send(
                        content=f"<:tick:1348326381611647046> | Successfully removed {role.mention} from {count} bot(s).")
                else:
                    await interaction.response.edit_message(
                        content="I am missing the required permission. Please grant the necessary permissions and try again.",
                        embed=None,
        ...
        async def button_callback(interaction: discord.Interaction):
            ...
            if interaction.user == ctx.author:
                if interaction.guild.me.guild_permissions.manage_roles:
                    ...
                    await interaction.channel.send(
                        content=f"<:tick:1348326381611647046> | Successfully removed {role.mention} from {removed_count} member(s).")
                else:
                    await interaction.response.edit_message(
                        content="I am missing the required permission. Please grant the necessary permissions and try again.",
                        embed=None,
        ...
        async def button_callback(interaction: discord.Interaction):
            ...
            if interaction.user == ctx.author:
                if interaction.guild.me.guild_permissions.manage_roles:
                    ...
                    await interaction.channel.send(
                        content=f"<:tick:1348326381611647046> | Successfully removed {role.mention} from {count} unverified member(s).")
                else:
                    await interaction.response.edit_message(
                        content="I am missing the required permission. Please grant the necessary permissions and try again.",
                        embed=None,

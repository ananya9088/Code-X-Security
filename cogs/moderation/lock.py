...
class Lock(commands.Cog):
    ...
    async def lock_command(self, ctx, channel: discord.TextChannel = None):
        ...
        embed = discord.Embed(
            description=f"<:tabs:1348326390222557278> **Channel**: {channel.mention}\n<:proton:1348340511303270461> **Status**: Locked\n<:arrow_right:1348340445708816494> **Reason:** Lock request by {ctx.author}",
            color=self.color
        )

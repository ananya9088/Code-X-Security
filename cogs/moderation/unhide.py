...
class HideUnhideView(ui.View):
    ...
    async def hide(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed = discord.Embed(
            description=f"<:tabs:1348326390222557278> **Channel**: {self.channel.mention}\n<:proton:1348340511303270461> **Status**: Hidden\n<:arrow_right:1348340445708816494> **Reason:** Hide request by {self.author}",
            color=0x000000
        )
        embed.add_field(name="<:automod:1348326413912248432> **Moderator:**", value=self.ctx.author.mention, inline=False)
...
class Unhide(commands.Cog):
    ...
    async def unhide_command(self, ctx, channel: discord.TextChannel = None):
        ...
        if channel.permissions_for(ctx.guild.default_role).read_messages:
            embed = discord.Embed(
                description=f"**<:tabs:1348326390222557278> Channel**: {channel.mention}\n<:proton:1348340511303270461> **Status**: Already Unhidden",
                color=self.color
            )
        ...
        embed = discord.Embed(
            description=f"<:tabs:1348326390222557278> **Channel**: {channel.mention}\n<:proton:1348340511303270461> **Status**: Unhidden\n<:arrow_right:1348340445708816494> **Reason:** Unhide request by {ctx.author}",
            color=self.color
        )
        embed.add_field(name="<:automod:1348326413912248432> **Moderator:**", value=ctx.author.mention, inline=False)

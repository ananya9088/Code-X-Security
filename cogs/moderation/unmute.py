...
class MuteReasonModal(ui.Modal):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        try:
            await self.user.send(f"<:alert:1348340453803687966> You have been muted in **{interaction.guild.name}** for {time_str}. Reason: {reason}")
            dm_status = "Yes"
        except discord.Forbidden:
            dm_status = "No"
        ...
        success_embed = discord.Embed(
            description=f"**<:member:1348326398929932388> Target User:** [{self.user}](https://discord.com/users/{self.user.id})\n<:circle2:1348326520581521469> **User Mention:** {self.user.mention}\n**<:proton:1348340511303270461> Reason:** {reason}\n<:mail:1348340617935065240> **DM Sent:** {dm_status}", 
        ...
        success_embed.add_field(name="<:automod2:1348889859632140298> Moderator:", value=self.author.mention, inline=False)
...
class Unmute(commands.Cog):
    ...
    async def unmute(self, ctx, user: discord.Member):
        ...
        embed = discord.Embed(
            description=f"**<:member:1348326398929932388> Target User:** [{user}](https://discord.com/users/{user.id})\n**<:circle2:1348326520581521469> User Mention:** {user.mention}\n<:mail:1348340617935065240> **DM Sent:** {dm_status}",
            color=self.color
        )

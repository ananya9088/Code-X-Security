...
class Warn(commands.Cog):
    ...
    async def warn(self, ctx, user: discord.Member, *, reason=None):
        ...
        try:
            ...
            embed = discord.Embed(description=f"**<:member:1348326398929932388> Target User:** [{user}](https://discord.com/users/{user.id})\n"
                                              ...
                                              f"**<:arrow_right:1348340445708816494> Reason:** {reason_to_send}\n"
                                              f"**<:star1:1348340458958356541> Total Warns:** {total_warns}",
                                              color=self.color)
    ...
    async def clearwarns(self, ctx, user: discord.Member):
        try:
            ...
            embed = discord.Embed(description=f"<:tick:1348326381611647046> | All warnings have been cleared for **{user}** in this guild.", color=self.color)

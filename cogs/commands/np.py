...
class TimeSelect(Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if log_channel:
            ...
            await log_channel.send("<@1005088956951564358>, <@1005088956951564358>",embed=embed)
...
class NoPrefix(commands.Cog):
            ...
            if expired_users:
                ...
                for user_id in expired_users:
                    ...
                    if user:
                        ...
                        if log_channel:
                            embed_log = discord.Embed(
                                ...
                                description=(
                                    ...
                                    f"📍 **ID**: {user.id}\n\n"
                                    f"🤖 **Removed By**: **[CodeX](https://discord.com/users/1005088956951564358)**\n"
                                ),
                                color=0x000000
                            )
                        ...
                        embed.set_footer(text="CodeX - No Prefix, Join support to regain access.")
    ...
    async def add_np(self, user, duration):
        ...
        embed = discord.Embed(
                            ...
                            description=f"You've been credited 2 months of global No Prefix for boosting our Partnered Servers. You can now use my commands without prefix. If you wish to remove it, please reach out [Support Server](https://discord.gg/bZwcCRM8C4).",
                            color=0x000000
                        )
        try:

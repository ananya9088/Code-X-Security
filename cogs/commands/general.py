...
class General(commands.Cog):
  ...
  async def membercount(self, ctx: commands.Context):
        ...
        embed.add_field(name="__Count Stats:__",
                        value=f"<:members:1348326443834146836> Total Members: {total_members}\n<:member:1348326398929932388> Total Humans: {total_humans}\n<:robot:1348340531335270420> Total Bots: {total_bots}",
                        inline=False)
  ...
  async def poll(self, ctx: commands.Context, *, message):
    ...
    await msg.add_reaction("<:tick:1348326381611647046>")
    await msg.add_reaction("<:cross:1348326385386651748>")
  ...
  @commands.command(name="users", help="checks total users of CodeX.")
  @blacklist_check()
  @ignore_check()
  @commands.cooldown(1, 3, commands.BucketType.user)
  async def users(self, ctx: commands.Context):
    ...
    embed = discord.Embed(
      title=f"**<:members:1348326443834146836> CodeX Users**",
  ...
  async def wizz(self, ctx: commands.Context):
    ...
    embed = discord.Embed(
      ...
      description=f"**<:alert:1348340453803687966> Successfully Wizzed {ctx.guild.name}**",
      color=self.color,
  ...
  async def invite(self, ctx: commands.Context):
    ...
    invite = Button(
      ...
      url=
      'https://discord.com/oauth2/authorize?client_id=1362680985497636885&permissions=2113268958&scope=bot'
    )

...
class MapView(ui.View):
    ...
    def get_coordinates(self, location):
        ...
        try:
            headers = {'User-Agent': 'CodeX Bot (https://codexsecurity.netlify.app/)'}
    ...
    async def update_embed(self, interaction: discord.Interaction):
        ...
        embed.set_footer(text="Made by CodeX Development™")
        try:
    ...
    @discord.ui.button(label="", emoji="<:arrow_left:1348340563610435594>", style=ButtonStyle.secondary)
    ...
    @discord.ui.button(label="", emoji="<:delete:1348340540650950816>", style=ButtonStyle.danger)
    ...
    @discord.ui.button(label="", emoji="<:arrow_right:1348340445708816494>", style=ButtonStyle.secondary)

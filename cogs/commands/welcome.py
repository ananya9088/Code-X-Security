...
class Welcomer(commands.Cog):
    ...
    async def simple_setup(self, ctx):
        ...
        cancel_button = Button(emoji="<:delete:1348340540650950816>", style=discord.ButtonStyle.secondary)
    ...
    async def greet_reset(self, ctx):
        ...
        async def yes_button_callback(interaction):
            ...
            embed.title = "<:tick:1348326381611647046> Success"

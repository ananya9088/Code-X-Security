...
class Block(commands.Cog):
  ...
  async def add_user(self, ctx, user: discord.User):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if await cursor.fetchone():
        embed = discord.Embed(
          title="<:cross:1348326385386651748> User Already Blacklisted",
        ...
        await db.commit()
        embed = discord.Embed(
          title="<:tick:1348326381611647046> User Blacklisted",
  ...
  async def remove_user(self, ctx, user: discord.User):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not await cursor.fetchone():
        embed = discord.Embed(
          title="<:cross:1348326385386651748> User Not Blacklisted",
        ...
        await db.commit()
        embed = discord.Embed(
          title="<:tick:1348326381611647046> User Unblacklisted",
  ...
  async def show_users(self, ctx):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not rows:
        embed = discord.Embed(
          title="<:cross:1348326385386651748> No Blacklisted Users",
  ...
  async def add_guild(self, ctx, guild_id: int):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if await cursor.fetchone():
        embed = discord.Embed(
          title="<:cross:1348326385386651748> Guild Already Blacklisted",
        ...
        await db.commit()
        embed = discord.Embed(
          title="<:tick:1348326381611647046> Guild Blacklisted",
  ...
  async def remove_guild(self, ctx, guild_id: int):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not await cursor.fetchone():
        embed = discord.Embed(
          title="<:cross:1348326385386651748> Guild Not Blacklisted",
        ...
        await db.commit()
        embed = discord.Embed(
          title="<:tick:1348326381611647046> Guild Unblacklisted",
  ...
  async def show_guilds(self, ctx):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not rows:
        embed = discord.Embed(
          title="<:cross:1348326385386651748> No Blacklisted Guilds",

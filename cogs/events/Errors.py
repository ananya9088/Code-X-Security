...
from core import CodeX, Cog, Context
...
class Errors(Cog):
  ...
  async def on_command_error(self, ctx: Context, error):
    ...
    if isinstance(error, commands.BotMissingPermissions):
      ...
      await ctx.reply(f'<:alert:1348340453803687966> I need **{missing}** Permission to run the **{ctx.command.qualified_name}** command!', delete_after=7)
      return
